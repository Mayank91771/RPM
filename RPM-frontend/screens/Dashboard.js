...
function Dashboard({ navigation }) {
  ...
  const [memberRetention, setMemberRetention] = useState(0);
  ...
  const getTotalMemberRetention = async () => {
    ...
    try {
      ...
      const memberRetentionRate = Math.floor(
        ((activeMemberCount - 1) / totalMemberCount) * 100
      );
        ...
        <ScrollView>
          <View style={styles.container}>
            ...
            <View style={styles.totalRevenueContainer}>
              ...
              <View>
                <Text style={{ fontSize: 20, fontWeight: "bold" }}>Member</Text>
                <Text style={{ fontSize: 20, fontWeight: "bold" }}>
                  Retention
                </Text>
              </View>
